...
## Environments
- Preview: https://main--eds-migrate--IamAdityaa1234.aem.page/
- Live: https://main--eds-migrate--IamAdityaa1234.aem.live/
...
1. Open the `eds-migrate` directory in your favorite IDE and start coding :)
